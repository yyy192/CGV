...
.tab-menu-round {
    clear: both;
    background: url('https://img.cgv.co.kr/R2014/images/common/bg/bg_tabmenu_grade.gif') 0 bottom repeat-x;
    width: 541px;
    height: 37px;
}
...
.box-login .login input[type="text"] {
    margin-bottom: 5px;
    background: url('https://img.cgv.co.kr/R2014/images/sprite/sprite_icon.png') 12px -230px no-repeat;
}

.box-login .login input[type="password"] {
    background: url('https://img.cgv.co.kr/R2014/images/sprite/sprite_icon.png') 12px -261px no-repeat;
}
...
.box-login fieldset > .login-option a2{
    ...
    margin-left: 5px;
    padding-right: 8px;
    background: url('https://img.cgv.co.kr/R2014/images/common/bg/bg_arrow03.png') right 1px no-repeat;
    font-size: 12px;
	...
	<div class="wrap-login">
		<div class="sect-login">
			<ul class="tab-menu-round">
	            <li class="on">
	                <a2 href="/user/login/">로그인</a2>
	            </li>      
        	</ul>
        	<p2>아이디 비밀번호를 입력하신 후, 로그인 버튼을 클릭해 주세요.</p2>
	        <div class="box-login">
	            <form id="frm" method="post" action="./memberLogin" novalidate="novalidate">
	            <fieldset>
	               
	                <div class="login">
	                    <input type="text" title="아이디" id="txtUserId" name="id" data-title="아이디를 " data-message="입력하세요." required="required">
	                    <input type="password" title="패스워드" id="txtPassword" name="pw" data-title="패스워드를 " data-message="입력하세요." required="required">
	                </div>
	                
	                <button type="submit" id="submit" title="로그인"><span>로그인</span></button>
	                <div class="save-id"> <input type="checkbox" id="loginSet" checked="checked"><label for="save_id">아이디 저장</label></div>
