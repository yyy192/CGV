	...
	<div class="detail_content_pa">
		<div class="snb">
			...
			<li class="side_1"><div></div></li>
				<li class="on"><a href="../member/mypage" title="현재 선택" class="on_1_1" >MY CGV HOME
						<i></i>
				</a></li>
				<li class="side_2"><div></div></li>
				<li class="on_2"><a href="/user/mycgv/reserve/?g=1"
					">나의 예매내역 </a></li>
			</ul>
		</div>
							...
							<div class="detail-area">
								<div class="reservation-info-wrap">
									<h2 class="box-contents artHouse">
										<a href="/movies/detail-view/?midx=84617" class="res-title movieName">${dto.movieName}</a>





										<span class="res-price_1">${dto.price}원</span>
									</h2>
						...
						<div class="resevation-payment-info">
							...
							<div class="resevation-payment">
								<p class="resevation-payment-total">
									<span class="totel-title">총 결제금액</span> <span class="res-price_2">
										${dto.price}원</span>
								</p>
