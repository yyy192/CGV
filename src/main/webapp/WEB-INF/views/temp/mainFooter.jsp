...
.sect-smuse {overflow:hidden; width:100%; border-top:1px solid #949494; border-bottom:1px solid #949494; height: 66px;}
...
.icon1{
	background-image: url("/s5/resources/images/4dx.png");
}
...
.sect-cinfo {padding-top:28px; height: 116px;}
.foot .sect-cinfo{}
/* Common Css : sect-cinfo */
.sect-cinfo .familysite, .sect-cinfo .share, .sect-cinfo .logo {position:absolute;}

.sect-cinfo .policy {width: auto; height:20px; letter-spacing:0px; }
.sect-cinfo .policy ul {width: auto; height: 20px; margin: 0 auto;}
			...
			<div class="sect-cinfo">
				...
				<div class="policy">
					<ul>
						...
						<li><a href="http://www.cgv.co.kr/company/cyberAudit.aspx"
