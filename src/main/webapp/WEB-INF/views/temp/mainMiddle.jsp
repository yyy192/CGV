...
<body>
	...
	<div class="cols-movie 0" style="display: none;">
		...
		<div id="Selection_R" class="col-ad a1">
			<iframe				
				src="https://adimg.cgv.co.kr/images/202109/killingkind/1011_240x388_.jpg"				
				width="240" height="388" title="킬링카인드" frameborder="0"
				scrolling="no" marginwidth="0" marginheight="0"
				name="Movie_Selection_R" id="Movie_Selection_R">				
			</iframe>			
		</div>
	...
	<div class="cols-movie 2" style="display: none;">
		...
		<div id="Selection_R" class="col-ad">
			<iframe
				...
				width="240" height="388" title="졸르트" frameborder="0"
				scrolling="no" marginwidth="0" marginheight="0"
				name="Movie_Selection_R" id="Movie_Selection_R"></iframe>
		</div>
	...
	<script type="text/javascript">
		...
		function i() {
			...
			if (flag == 0) {
				...
				$('.a1').click(function () {
					 location.href = "http://www.cgv.co.kr/movies/detail-view/?midx=84945";
					 console.log('aaa');
				});	
			} else if (flag == 1) {
				$('.1').show();
